...
//  access, action,        menu label,              implementation class
    ...
    [ 'a', 'playlistPicker','Playlists by Date',    ZK\UI\Playlists::class ],
    [ 'a', 'viewList',     0,                       ZK\UI\Playlists::class ],    
    [ 'a', 'playlistDaysByDate%',0,                 ZK\UI\Playlists::class ],
    [ 'a', 'playlistsByDate%',0,                    ZK\UI\Playlists::class ],
