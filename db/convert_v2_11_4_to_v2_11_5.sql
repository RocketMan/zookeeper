 ...
 * v2_11_4 database for use with the current codebase.
 *
...
ALTER TABLE `albumvol` ADD FULLTEXT KEY `artist_3` (`artist`);
ALTER TABLE `colltracknames` ADD FULLTEXT KEY `artist_3` (`artist`);
