...
<?php
    ...
    private function getLabel() {
         ...
         $label["foreign"] ??= false;
AH00526: Syntax error on line 14 of /etc/modsecurity/crs/crs-setup.conf:
SecRequestBodyInMemoryLimit takes one argument, maximum request body size that will be placed in memory (except for POST urlencoded requests).
         return $label;
    }
