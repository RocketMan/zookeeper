...
* License:  LGPL                                                              *
*                                                                             *
* Zookeeper-specific changes (1.25.1):                                        *
* 1. changed metrics .mtx file path reference from absolute to relative       *
* 2. removed all core fonts except helvetica                                  *
* 3. added method _put (from FPDF 1.81)                                       *
******************************************************************************/
