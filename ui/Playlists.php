...
class Playlists extends MenuItem {
    ...
    private function makeEditDiv($row, $playlist) {
        ...
        $upLink = "<A CLASS='songUp' HREF='" . $href ."seq=downTrack' />";
        $downLink = "<A CLASS='songDown' HREF='" . $href ."seq=upTrack' />";
    ...
    private function makePlaylistHeader($isEditMode) {
        ...
        $header = "<TR ALIGN=LEFT>" . $editCol . "<TH WIDTH='60px'>Time</TH><TH WIDTH='25%'>" .
    ...
    private function emitPlaylistBody($playlist, $editMode) {
        ...
        $editCell = "";
        echo "<TABLE CELLPADDING=1>".$header;
    ...
    private function viewList($playlist) {
        ...
        echo "<DIV CLASS='playlistHdr'>&nbsp;" . $showName . " with " . $djLink.$dateDiv . "</div>";
